...
function(do_fetch)
  ...
  execute_process(
    ...
    WORKING_DIRECTORY "/home/runner/workspace/build/_deps/eigen-src"
...
execute_process(
  COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git show-ref "3.4.0"
  WORKING_DIRECTORY "/home/runner/workspace/build/_deps/eigen-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/workspace/build/_deps/eigen-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/workspace/build/_deps/eigen-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
