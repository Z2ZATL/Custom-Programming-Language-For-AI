...
function(do_fetch)
  ...
  execute_process(
    COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git fetch --tags --force "origin"
    WORKING_DIRECTORY "/home/runner/workspace/build/_deps/googletest-src"
...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "/home/runner/workspace/build/_deps/googletest-src"
...
execute_process(
  COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git show-ref "release-1.11.0"
  WORKING_DIRECTORY "/home/runner/workspace/build/_deps/googletest-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "/home/runner/workspace/build/_deps/googletest-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "/home/runner/workspace/build/_deps/googletest-src"
...
execute_process(
  COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "/home/runner/workspace/build/_deps/googletest-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/home/runner/workspace/build/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "/home/runner/workspace/build/_deps/googletest-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "/home/runner/workspace/build/_deps/googletest-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "/home/runner/workspace/build/_deps/googletest-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "/home/runner/workspace/build/_deps/googletest-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/workspace/build/_deps/googletest-src'."
    ...
    execute_process(
      COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "/home/runner/workspace/build/_deps/googletest-src"
    )
    execute_process(
      COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "/home/runner/workspace/build/_deps/googletest-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "/home/runner/workspace/build/_deps/googletest-src"
      )
      execute_process(
        COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git" --git-dir=.git stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/workspace/build/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "/nix/store/bcsji16g1szdg0j8znlvbkbfxpkvlgiz-replit-runtime-path/bin/git"
            --git-dir=.git 
